...
@section('title', 'Cadastro de Criptomoeda')
...
<body>
    ...
    <div id="crypto-wrapper">
        ...
        <form action="{{ route('criptos.store') }}" method="POST">
        @csrf
        <input type="text" name="nome" placeholder="Nome" required>        
        <input type="number" name="quantidade" placeholder="Quantidade" required>
        <input type="date" name="data_compra" required>
        <input type="text" name="descricao" placeholder="Descrição">
        <input type="text" name="valorUnitario" placeholder="Valor unitário">
